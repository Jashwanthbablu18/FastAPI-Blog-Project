...
# Serve static files (CSS, JavaScript, images, etc.) from the "static" folder
app.mount("/static", StaticFiles(directory="static"), name="static")

app.mount("/media", StaticFiles(directory="media"), name="media")

# Load HTML templates from the "templates" folder using Jinja2
templates = Jinja2Templates(directory="templates")

# ==========================
# Web Routes (HTML Pages)
# ==========================
# These routes render HTML templates and are viewed in the browser / used for Jinja2Templates.
